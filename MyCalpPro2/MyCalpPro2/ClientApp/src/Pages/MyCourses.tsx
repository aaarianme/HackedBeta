  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex items-center justify-center flex-col min-h-screen bg-slate-200">
        <div className="break-inside relative overflow-hidden flex flex-col justify-between space-y-2 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-purple-700 text-white">
          <span className="uppercase text-lg mb-1 text-[#D2BDFF]">
            CMPE2300
          </span>
          <div className="flex flex-row items-center space-x-3">
            ...
            <span className="text-base font-medium">
              Congratulations, Nothing due for this class!
            </span>
          </div>
        </div>
        <div className="break-inside relative border-1 overflow-hidden flex flex-col justify-between space-y-3 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-white text-black dark:bg-slate-800 dark:text-white">
          <div className="flex items-center justify-between font-medium">
            <span className="uppercase text-xs text-purple-500">CMPE2300</span>
            <span className="text-xs text-slate-500">3 assignments</span>
          </div>
          <div className="flex flex-row items-center space-x-3">
            ...
            <span className="text-base font-medium">
              Your next assignment is due YYYY-MM-DD
            </span>
          </div>
          <div>
